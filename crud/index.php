                 ...
                 Inner join cities on reg.city = cities.id";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><? echo $row1['mo'] ?></td>
                                        <td><? echo $row1['gender'] ?></td>
                                        <td><? echo $row1['loc'] ?></td>
                                        <td><? echo $row1['country'] ?></td>
                                        <td><? echo $row1['state'] ?></td>
                                        <td><? echo $row1['city'] ?></td>
                                        <td><a href="#" id="<? echo $row1['id'] ?>" class="btn btn-primary edit">Edit</td>
                                        <td><a href="#" id="<? echo $row1['id'] ?>" class="btn btn-primary delete">Delete</td>
